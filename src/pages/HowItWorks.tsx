    ...
    <Layout>
      ...
      <section className="section-padding bg-white">
        <div className="container-content max-w-3xl animate-fade-up">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-12 text-justify">{t('hiw.hero.body')}</p>
          ...
          <div
            ...
            style={{ animationDelay: `${i * 100}ms` }}>
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground leading-relaxed text-justify">{step.desc}</p>
              </div>
